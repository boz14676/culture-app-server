...
class SmsSingleSender {
     ...
     */
    function _send($type, $nationCode, $phoneNumber) {
        $code = 123456;
        Cache::put($phoneNumber, $code, 30);
        // 发送成功
        return ['error_code'=>0];
    }
    ...
    function send($type, $nationCode, $phoneNumber, $msg="", $extend = "", $ext = "") {
        ...
        */
        ...
        if ($rsp['result'] == 0) {
            ...
            // 发送成功
            return ['error_code'=>1, 'error_desc'=>$rsp['errmsg']];
        }
    }
    ...
    public static function verify($mobile, $code) {
        if (Cache::get($mobile) && Cache::get($mobile) == $code) {
            return true;
        }
        return false;
    }
